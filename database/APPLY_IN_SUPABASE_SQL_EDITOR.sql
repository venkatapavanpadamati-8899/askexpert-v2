-- ==============================================================================
-- ASKEXPERT - PRODUCTION MIGRATION: FREE KYC & ADMIN APPROVAL GATE
-- Run this script in: Supabase Dashboard -> SQL Editor -> New Query -> Run
-- Target Project: girexuzrkeiylkbqglks (ASKEXPERT)
-- ==============================================================================
...
-- 2. Ensure check constraints for last_four_consistency if not present
DO $$
BEGIN
  IF NOT EXISTS (
...
-- 3. Create secure RPC function for Admin Approval / Rejection / Resubmission
...
BEGIN
  ...
  IF v_decision = 'APPROVED' THEN
    -- Required professional documents check (Degree and License required; Aadhaar is optional in Free-KYC)
...
-- 4. Set secure execution privileges
